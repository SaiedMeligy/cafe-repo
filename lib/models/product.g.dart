...
void _productSerialize(
  ...
  writer.writeLong(offsets[4], object.stockCount);
}
...
Product _productDeserialize(
  ...
  object.stockCount = reader.readLong(offsets[4]);
  return object;
}
...
extension ProductQueryFilter
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> stockCountEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'stockCount',
        value: value,
      ));
    });
  }

  QueryBuilder<Product, Product, QAfterFilterCondition> stockCountGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> stockCountLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> stockCountBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ProductQuerySortBy on QueryBuilder<Product, Product, QSortBy> {
  ...
  QueryBuilder<Product, Product, QAfterSortBy> sortByStockCount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'stockCount', Sort.asc);
    });
  }

  QueryBuilder<Product, Product, QAfterSortBy> sortByStockCountDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'stockCount', Sort.desc);
    });
  }
}
...
extension ProductQuerySortThenBy
  ...
  QueryBuilder<Product, Product, QAfterSortBy> thenByStockCount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'stockCount', Sort.asc);
    });
  }

  QueryBuilder<Product, Product, QAfterSortBy> thenByStockCountDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'stockCount', Sort.desc);
    });
  }
...
extension ProductQueryWhereDistinct
  ...
  QueryBuilder<Product, Product, QDistinct> distinctByStockCount() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'stockCount');
    });
  }
}
...
extension ProductQueryProperty
  ...
  QueryBuilder<Product, int, QQueryOperations> stockCountProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'stockCount');
    });
  }
}
